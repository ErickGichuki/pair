    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-md p-8 space-y-6 bg-yellow-300 shadow-lg rounded-lg">
        ...
        <form onSubmit={formik.handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full py-3 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
          >
            → Register
          </button>
        </form>
